    ...
    <div class="container-fluid py-2">
        ...
        <div class="row g-4 mb-4">
                ...
                <div class="card border-0 shadow-sm h-100 transition-up" style="border-radius: 20px;">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div class="icon-box bg-light-primary text-primary rounded-4 d-flex align-items-center justify-content-center"
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 transition-up" style="border-radius: 20px;">
                    <div class="card-body p-4">
                        <div class="icon-box bg-light-secondary text-secondary rounded-4 d-flex align-items-center justify-content-center mb-3"
                            style="width: 48px; height: 48px;">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 transition-up" style="border-radius: 20px;">
                    <div class="card-body p-4">
                        <div class="icon-box bg-light-info text-info rounded-4 d-flex align-items-center justify-content-center mb-3"
                            style="width: 48px; height: 48px;">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 transition-up" style="border-radius: 20px;">
                    <div class="card-body p-4">
                        <div class="icon-box bg-light-success text-success rounded-4 d-flex align-items-center justify-content-center mb-3"
                            style="width: 48px; height: 48px;">
        ...
        <div class="mb-4">
            <div class="dropdown">
                <button class="btn btn-white border-0 shadow-sm dropdown-toggle fw-600 px-4 py-2" type="button"
                    data-bs-toggle="dropdown" style="border-radius: 12px;">
                ...
                <ul class="dropdown-menu shadow border-0 p-2" style="border-radius: 15px;">
                    <li><a class="dropdown-item rounded-3 {{ $status === 'Semua' ? 'active' : '' }}"
                            href="{{ route('admin.laporan.index', ['status' => 'Semua']) }}">Semua Laporan</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    @foreach ($statusConfig as $name => $cfg)
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center rounded-3 {{ $status === $name ? 'active' : '' }}"
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 24px;">
                    <div class="card-header bg-white border-0 p-4">
                        <h5 class="fw-800 mb-1 text-dark">Data Laporan &mdash; <span
                                class="text-warning">{{ strtoupper($status) }}</span></h5>
                                        ...
                                        <tr>
                                            <td class="ps-4 py-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-bold text-dark mb-0">{{ Str::limit($r->judul, 45) }}
                                                        </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="badge-dot d-flex align-items-center gap-2">
                                                    <span class="d-inline-block rounded-circle bg-{{ $currentCfg[0] }}"
                                                        style="width: 8px; height: 8px;"></span>
                                                    <span
                                                        class="text-{{ $currentCfg[0] }} fw-800 small text-uppercase">{{ $r->status }}</span>
                                                </div>
                                            </td>
                                            <td class="text-center pe-4">
                                                <a href="{{ route('admin.laporan.show', $r->id) }}"
                                                    class="btn btn-dark btn-sm rounded-3 px-3 fw-600">
                                                    Detail
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-5">
                                                <img src="https://cdn-icons-png.flaticon.com/512/7486/7486744.png"
                                                    alt="empty" width="60" class="opacity-25 mb-3">
