...
@section('content')
    <div class="container-fluid py-2">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-md-flex align-items-center justify-content-between bg-white p-4 shadow-sm border-0"
                    ...
                    <div class="d-flex align-items-center gap-4">
                        <div class="position-relative">
                            ...
                            <span
                                class="position-absolute bottom-0 end-0 badge border border-2 border-white rounded-circle bg-success p-2">
                    ...
                    <div class="card border-0 shadow-sm h-100 transition-up" style="border-radius: 20px;">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="icon-box {{ $card[4] }} text-{{ $card[3] }} rounded-4 d-flex align-items-center justify-content-center"
                                    style="width: 48px; height: 48px;">
                                    <i class="bi {{ $card[2] }} fs-4"></i>
                                </div>
                                <span class="badge rounded-pill bg-light text-muted border-0 small px-2">Live</span>
                            </div>
                            <h6 class="text-muted fw-600 text-uppercase small mb-1" style="letter-spacing: 1px;">
                                {{ $card[0] }}</h6>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                <thead class="bg-light-subtle border-bottom border-light">
                                    <tr>
                                        <th class="ps-4 py-3 text-muted fw-600 small" style="width: 40%;">INFORMASI LAPORAN
                                        </th>
                                ...
                                <tbody>
                                    @forelse($recent_reports as $report)
                                        @php
                                            ...
                                            $priority = match ($report->prioritas ?? 'Rendah') {
                                        ...
                                        <tr class="{{ ($report->prioritas ?? '') == 'Darurat' ? 'table-danger' : '' }}"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-muted small mt-1">
                                                            ...
                                                            {{ Str::limit($report->lokasi ?? 'N/A', 35) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <span class="badge border text-dark fw-500 bg-white px-3 py-2"
                                            ...
                                            <td class="pe-4">
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    <div class="badge-dot d-flex align-items-center gap-2 mb-1">
                                                        <span class="d-inline-block rounded-circle {{ $config[2] }}"
                                                            style="width: 8px; height: 8px;"></span>
                                                        <span class="text-{{ $config[1] }} fw-800 small text-uppercase">
                                                            {{ $config[0] }}
                                                        </span>
                                                    </div>
                                                    ...
                                                    @if (isset($report->prioritas))
                                                        <span
                                                            class="badge bg-{{ $priority[0] }}-subtle text-{{ $priority[0] }} mt-1 px-2 py-1"
                                                            style="font-size:0.65rem;">
                                                            <i class="bi {{ $priority[1] }} me-1"></i>
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-center py-5">
                                                <img src="https://cdn-icons-png.flaticon.com/512/7486/7486744.png"
                                                    alt="empty" width="80" class="opacity-25 mb-3">
